...
import { Briefcase, LayoutDashboard, Sparkles, ExternalLink } from 'lucide-react';
...
function RootComponent() {
	...
	return (
		<Html lang="ko" className="dark">
			...
			<Body className="bg-background text-foreground flex flex-col min-h-screen antialiased selection:bg-primary/30">
				{/* 글로벌 네비게이션 헤더 */}
